...
var SolidCompWrapperFactory = class extends agGridCommunity.BaseComponentWrapper {
...
var BeansContext = solidJs.createContext({});
...
var DetailCellRenderer = (props) => {
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      ...
      return () => _c$() && web.createComponent(agGridSolid_default, web.mergeProps({
        get ["class"]() {
...
var UserComp = (p) => {
  ...
  return [web.memo(() => web.memo(() => !!showSolidComp())() && web.createComponent(solidUserComp_default, {
    get compDetails() {
  ...
  })), web.memo(() => web.memo(() => !!showJsComp())() && web.createComponent(jsUserComp_default, {
    get compDetails() {
      return p.compDetails;
    },
    ref(r$) {
...
var _tmpl$2 = /* @__PURE__ */ web.template(`<span><span></span><span></span><span></span><span class=ag-group-value></span><span class=ag-group-child-count>`);
var GroupCellRenderer = (props) => {
  ...
  return (() => {
    ...
    web.insert(_el$5, (() => {
      ...
      return () => _c$() && web.createComponent(userComp_default, {
        get compDetails() {
...
var SolidFrameworkOverrides = class extends agGridCommunity.VanillaFrameworkOverrides {
  constructor() {
    super("solid");
  }
  frameworkComponents = {
...
var _tmpl$3 = /* @__PURE__ */ web.template(`<div class=ag-header-cell role=columnheader><div class=ag-header-cell-resize role=presentation></div><div class=ag-header-cell-comp-wrapper role=presentation>`);
var HeaderCellComp = (props) => {
  ...
  return (() => {
    ...
    web.effect((_p$) => {
      var _v$ = style(), _v$2 = getColId(), _v$3 = getAriaSort();
...
var _tmpl$4 = /* @__PURE__ */ web.template(`<div role=gridcell><div role=presentation></div><div role=presentation><button type=button class="ag-button ag-floating-filter-button-button"tabindex=-1>`);
...
var _tmpl$5 = /* @__PURE__ */ web.template(`<div role=columnheader><div>`);
var HeaderGroupCellComp = (props) => {
  ...
  return (() => {
    ...
    typeof _ref$2 === "function" ? web.use(_ref$2, _el$2) : eResize = _el$2;
    web.effect((_p$) => {
      var _v$ = getClassName(), _v$2 = style(), _v$3 = getColId(), _v$4 = getAriaExpanded(), _v$5 = getResizableAriaHidden(), _v$6 = getResizableClassName();
      _v$ !== _p$.e && web.className(_el$, _p$.e = _v$);
      _p$.t = web.style(_el$, _v$2, _p$.t);
...
var _tmpl$6 = /* @__PURE__ */ web.template(`<div role=row>`);
var HeaderRowComp = (props) => {
  ...
  const createCellJsx = (cellCtrl) => {
    switch (ctrl.getType()) {
      case agGridCommunity.HeaderRowType.COLUMN_GROUP:
        return web.createComponent(headerGroupCellComp_default, {
          ctrl: cellCtrl
        });
      case agGridCommunity.HeaderRowType.FLOATING_FILTER:
        return web.createComponent(headerFilterCellComp_default, {
          ctrl: cellCtrl
        });
      default:
        return web.createComponent(headerCellComp_default, {
          ctrl: cellCtrl
        });
    }
  };
  return (() => {
    ...
    web.effect((_p$) => {
      var _v$ = style(), _v$2 = getAriaRowIndex();
      _p$.e = web.style(_el$, _v$, _p$.e);
...
var _tmpl$7 = /* @__PURE__ */ web.template(`<div role=rowgroup>`);
var _tmpl$22 = /* @__PURE__ */ web.template(`<div role=presentation><div class=ag-header-container role=rowgroup>`);
var HeaderRowContainerComp = (props) => {
  ...
  const insertRowsJsx = () => web.createComponent(solidJs.For, {
    ...
    children: (ctrl) => web.createComponent(headerRowComp_default, {
      ctrl
    })
  });
...
var GridHeaderComp = () => {
  ...
  return (() => {
    ...
    var _ref$ = eGui;
    typeof _ref$ === "function" ? web.use(_ref$, _el$) : eGui = _el$;
    web.insert(_el$, web.createComponent(headerRowContainerComp_default, {
      pinned: "left"
    }), null);
    web.insert(_el$, web.createComponent(headerRowContainerComp_default, {
      pinned: null
...
var ShowEditDetails = (props) => {
  ...
  return [inPopup && web.createComponent(popupEditorComp_default, {
    get cellCtrl() {
    ...
    get children() {
      return web.createComponent(userComp_default, {
        get compDetails() {
  ...
  }), !inPopup && web.createComponent(userComp_default, {
    get compDetails() {
      return getCompDetails();
    },
    ref(r$) {
...
var _tmpl$9 = /* @__PURE__ */ web.template(`<span role=presentation class=ag-cell-value>`);
var ToolsComp = (props) => {
  const {
    context
  } = solidJs.useContext(BeansContext);
  ...
  return [web.memo(() => web.memo(() => !!props.includeSelection)() && web.createComponent(CompWrapper, {
    createFn: () => {
  ...
  })), web.memo(() => web.memo(() => !!props.includeDndSource)() && web.createComponent(CompWrapper, {
    createFn: () => props.cellCtrl.createDndSource()
  })), web.memo(() => web.memo(() => !!props.includeRowDrag)() && web.createComponent(CompWrapper, {
...
var ShowRenderDetails = (props) => {
  ...
  const bodyJsxFunc = () => [web.memo(() => web.memo(() => !!isNoCompDetails())() && web.memo(valueForNoCellRenderer)), web.memo(() => web.memo(() => !!getCompDetails())() && web.createComponent(userComp_default, {
    get compDetails() {
      return getCompDetails();
    },
    ref(r$) {
  ...
  return [web.memo(() => web.memo(() => !!props.showTools)() && web.createComponent(ToolsComp, {
  ...
  })), web.memo(() => web.memo(() => !!props.showCellWrapper)() ? (() => {
    var _el$ = _tmpl$9();
...
var _tmpl$10 = /* @__PURE__ */ web.template(`<div> `);
var _tmpl$23 = /* @__PURE__ */ web.template(`<div class=ag-cell-wrapper role=presentation>`);
var checkCellEditorDeprecations = (popup, cellEditor, cellCtrl) => {
  ...
  if (!popup && cellEditor.isPopup && cellEditor.isPopup()) {
    ...
    agGridCommunity._.doOnce(() => void 0, "jsEditorComp-isPopup-" + cellCtrl.getColumn().getColId());
  }
  if (popup && cellEditor.getPopupPosition && cellEditor.getPopupPosition() != null) {
    ...
    agGridCommunity._.doOnce(() => void 0, "jsEditorComp-getPopupPosition-" + cellCtrl.getColumn().getColId());
  }
};
var CellComp = (props) => {
  const {
  ...
  const bodyJsxFunc = () => [web.createComponent(solidJs.For, {
    ...
    children: () => web.memo(() => web.memo(() => !!renderDetails())() && web.createComponent(showRenderDetails_default, {
      get showDetails() {
  ...
  }), web.memo(() => web.memo(() => !!editDetails())() && web.createComponent(showEditDetails_default, {
    get editDetails() {
      return editDetails();
    },
    cellCtrl,
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      var _c$ = web.memo(() => !!showCellWrapper());
      return () => _c$() ? (() => {
        var _el$3 = _tmpl$23();
...
var _tmpl$11 = /* @__PURE__ */ web.template(`<div role=row>`);
...
var RowComp = (params) => {
  ...
  const showCellsJsx = () => web.createComponent(solidJs.For, {
    ...
    children: (cellCtrl) => web.createComponent(cellComp_default, {
      cellCtrl,
      get editingRow() {
  ...
  const showFullWidthJsx = () => web.createComponent(userComp_default, {
    get compDetails() {
...
var _tmpl$12 = /* @__PURE__ */ web.template(`<div role=rowgroup>`);
var _tmpl$24 = /* @__PURE__ */ web.template(`<div role=presentation>`);
var RowContainerComp = (props) => {
  ...
  const buildContainer = () => (() => {
    ...
    web.insert(_el$, web.createComponent(solidJs.For, {
      ...
      children: (rowCtrl, i) => web.createComponent(rowComp_default, {
        rowCtrl,
        get containerType() {
...
var _tmpl$13 = /* @__PURE__ */ web.template(`<div role=treegrid><div role=presentation></div><div role=presentation><div role=presentation></div></div><div role=presentation></div><div role=presentation>`);
var GridBodyComp = () => {
  const {
    context,
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(gridHeaderComp_default, {}), _el$2);
    var _ref$2 = eTop;
    typeof _ref$2 === "function" ? web.use(_ref$2, _el$2) : eTop = _el$2;
    web.insert(_el$2, web.createComponent(rowContainerComp_default, {
      get name() {
    ...
    web.insert(_el$4, web.createComponent(rowContainerComp_default, {
      get name() {
    ...
    web.insert(_el$5, web.createComponent(rowContainerComp_default, {
      get name() {
    ...
    web.insert(_el$6, web.createComponent(rowContainerComp_default, {
      get name() {
...
var _tmpl$14 = /* @__PURE__ */ web.template(`<div role=presentation>`);
var TabGuardComp = (props) => {
  ...
  return [(() => {
    ...
    web.effect((_p$) => {
      var _v$ = `${agGridCommunity.TabGuardClassNames.TAB_GUARD} ${agGridCommunity.TabGuardClassNames.TAB_GUARD_TOP}`, _v$2 = tabIndex();
      _v$ !== _p$.e && web.className(_el$, _p$.e = _v$);
      _v$2 !== _p$.t && web.setAttribute(_el$, "tabindex", _p$.t = _v$2);
      return _p$;
    }, {
    ...
    web.effect((_p$) => {
      var _v$3 = `${agGridCommunity.TabGuardClassNames.TAB_GUARD} ${agGridCommunity.TabGuardClassNames.TAB_GUARD_BOTTOM}`, _v$4 = tabIndex();
...
var _tmpl$15 = /* @__PURE__ */ web.template(`<div><div>`);
var GridComp = (props) => {
  ...
  return (() => {
    ...
    web.insert(_el$2, (() => {
      ...
      web.createComponent(BeansContext.Provider, {
        value: beans,
        get children() {
          return web.createComponent(tabGuardComp_default, {
            ref: setTabGuardRef,
            ...
            get children() {
              return web.createComponent(gridBodyComp_default, {});
            }
          });
        }
      });
...
// src/grid/agGridSolid.tsx
var _tmpl$16 = /* @__PURE__ */ web.template(`<div>`);
var AgGridSolid = function(props) {
  ...
  solidJs.onMount(() => {
    ...
    const createUiCallback = (context2) => {
      setContext(context2);
      const ctrlsService = context2.getBean(agGridCommunity.CtrlsService.NAME);
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      ...
      return () => _c$() && web.createComponent(gridComp_default, {
        get ["class"]() {
          return props.class;
        },
        get context() {
...
// src/index.tsx
exports.default = agGridSolid_default;
